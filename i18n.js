const translations = {
    "ru": {
        ...
        "about-stat": "заказов выполнено<br>с 2008 года",
        "about-title": "Кухни на заказ от<br>фабрики «NEFF»",
        "about-desc": "Мебельная фабрика NEFF. Мы занимаемся разработкой, производством и реализацией мебели по индивидуальному проекту.",
